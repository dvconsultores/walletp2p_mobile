...
class _SelectCryptoPageState extends State<SelectCryptoPage> {
  ...
  final listCryto = [
    ...
    CryptoModel(
      icon: "assets/logos/btc.png",
      coin: "BTC",
      name: "BITCOIN",
      amount: 0.259,
    ),
    CryptoModel(
      icon: "assets/logos/usdt.png",
      coin: "USDT",
      name: "THETHER",
      amount: 1938.47,
    ),
    CryptoModel(
      icon: "assets/logos/sol.png",
      coin: "SOL",
      name: "SOLANA",
      amount: 257.93,
    ),
    CryptoModel(
      icon: "assets/logos/matic.png",
      coin: "MATIC",
      name: "POLYGON",
      amount: 148.54,
    ),
    CryptoModel(
      icon: "assets/logos/usdc.png",
      coin: "USDC",
      name: "USD COIN",
      amount: 193.49,
    ),
    CryptoModel(
      icon: "assets/logos/dai.png",
      coin: "DAI",
      name: "DAI",
      amount: 327.44,
    ),
    CryptoModel(
      icon: "assets/logos/klay.png",
      coin: "KLAY",
      name: "KLAYTN",
      amount: 274.34,
    ),
    CryptoModel(
      icon: "assets/logos/shib.png",
      coin: "SHIB",
      name: "SHIBA INU",
      amount: 5277.86,
    ),
    CryptoModel(
      icon: "assets/logos/snx.png",
      coin: "SNX",
      name: "SYNTHETIX",
      amount: 538.25,
    ),
