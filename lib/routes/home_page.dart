            ...
            Padding(
                ...
                child: Column(children: [
                  AppHeader(
                    showOptions: true,
                    leadingWidget:
                        Image.asset("assets/logos/logo.png", width: 35),
                  ),
                  const Gap(26).column,
                  Row(children: [
                    Expanded(
                          ...
                          Padding(
                            ...
                            child: Column(children: [
                              Button.icon(
                                ...
                                onPressed: floatingButtons[i]['action'] as void
                                    Function(),
                              ),
                              const Gap(8).column,
                              Text(
            ...
            Padding(
                ...
                child: Stack(children: [
                  ...
                  Column(children: [
                    ...
                    AppFooter(
                        padding: EdgeInsets.only(
                            top: 25, bottom: Variables.paddingScaffold.bottom))
                  ]),
                ]))
          ])),
    );
